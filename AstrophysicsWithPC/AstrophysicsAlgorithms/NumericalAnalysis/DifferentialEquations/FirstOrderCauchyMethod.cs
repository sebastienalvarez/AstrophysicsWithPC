 ...
 * 
 * Objet : Classe permettant de calculer la solution d'un équation différentielle du 1er ordre par la méthode de Cauchy.
 * 
 ****************************************************************************************************************************************/
...
{
    public class FirstOrderCauchyMethod : FirstOrderDifferentialEquation
    {
        // CONSTRUCTEUR
        /// <summary>
        ...
        public FirstOrderCauchyMethod(Func<double, double, double> a_equation) : base(a_equation)
        {
        }
        ...
        {
            double midx = a_x + 0.5 * a_increment;
            double midy = a_y + 0.5 * a_increment * Equation(a_x, a_y);
            double y = a_y + a_increment * Equation(midx, midy);
